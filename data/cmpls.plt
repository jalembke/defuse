...
#set ylabel "Runtime (sec)" offset 1.8 font "Times,22"
#set ylabel "Read Bandwidth (kB/s)" offset 3.7 font "Times,22"

# Divide by 1000 to convert kB to MB
# 2, 3, 4, 5 are the indexes of the columns; 'fc' stands for 'fillcolor'
plot dat_file using ($2/1000):xtic(1) ti col fs pattern 1, \
           '' using ($3/1000) ti col fs pattern 2, \
           '' using ($4/1000) ti col fs pattern 4, \
           '' using ($5/1000) ti col fs pattern 5
